...
public class EncryptionManager 
{
     ...
     */
    public EncryptionManager(byte[] publicKey, byte[] privateKey) throws NoSuchAlgorithmException, 
     ...
     */
    public boolean verify(byte[] data, byte[] sig) throws NoSuchAlgorithmException, 
